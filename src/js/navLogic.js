export class Menu {
    ...
    init() {
        ...
        this.menuElement.addEventListener("click", (e) => {
            ...
            const isNavLinkInDropdown = 
                target.tagName === 'A' && 
                target.closest('.innerList') && 
        ...
        document.addEventListener(`${this.options.action}`, (e) => {
            ...
            const mouseOverBehavior = this.options.action == Menu.ACTION_MOUSEOVER && target.classList.contains("is-active");
